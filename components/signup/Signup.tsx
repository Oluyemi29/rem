    ...
    <div className="w-full flex flex-col py-10 justify-center items-center">
      <div className="w-full flex flex-row items-center gap-5">
        <div className="w-full md:block hidden">
          <Image
            src={
              "https://i.pinimg.com/1200x/0c/9b/89/0c9b89b62ba04b4b4740f4ce2da28b54.jpg"
            }
            alt="Image"
            width={"100"}
            height={"100"}
        ...
        >
          ...
          <div className="flex flex-col gap-1 md:w-1/2 w-full">
            <p className="text-sm text-deepBlue">First Name</p>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1 md:w-1/2 w-full">
            <p className="text-sm text-deepBlue">Last Name</p>
            <input
              type="text"
              className="w-full h-12 border-2 px-3 rounded-md text-sm border-deepBlue bg-deepBlue/5"
              placeholder="First name"
